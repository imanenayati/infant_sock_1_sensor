...
not support low-energy bluetooth functionality. Contact author for inquiries and/or
support.
...
const int analogInPin1 = A5;  //pressure fabric for OUTSIDE, PIXEL 1
...
void setup() {
  ...
  pinMode(A5, INPUT_PULLUP); //sensor pin
